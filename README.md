...
See [`examples/airpods/`](examples/airpods/) for the AirPods case from the
cover figure of the paper, stylized with a "round stone roof" texture: the
base `.obj`, the heightfield generated by the fine-tuned VAE, and the final
displaced mesh.
